...
import '../../UI/controller/authController.dart';
  ...
  static Future<NetworkResponse> postRequest({required String url , Map<String, dynamic>?body}) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _moveTOLoginScreen();
        return NetworkResponse(
            isSuccess: false, statusCode: response.statusCode,errorMassage: "Un-authorize user. Please login again");
      }
...
/// logger method;
  ...
  static Future<void> _moveTOLoginScreen()async{
    ...
    Navigator.pushAndRemoveUntil(TaskApp.navigatorKey.currentContext!, MaterialPageRoute(builder: (context)=>LoginScreen()), (pre)=>false);
  }
}
